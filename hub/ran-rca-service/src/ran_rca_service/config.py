...
# Mantis ML classify
MANTIS_ENABLED = _env_bool("MANTIS_ENABLED", False)
CLASSIFY_INFERENCE_URL = os.getenv("CLASSIFY_INFERENCE_URL", "")
MANTIS_CONFIDENCE_THRESHOLD = float(os.getenv("MANTIS_CONFIDENCE_THRESHOLD", "0.6"))
